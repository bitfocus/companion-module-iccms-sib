import { sibHttpClientRundownSelectNextItem } from '../../../infrastructure/connection/sibHttpClient.js';
...
describe('sibHttpClientRundownSelectNextItem', () => {
  ...
  it('should construct the correct URL with token', async () => {
    ...
    const result = await sibHttpClientRundownSelectNextItem(
      mockBaseUrl,
      mockToken,
      mockDeviceId
    );
    ...
    expect(http.get).toHaveBeenCalledWith(
      expect.stringContaining('/api/rundown/select-next/'),
      expect.any(Function)
    );
    expect(http.get).toHaveBeenCalledWith(
