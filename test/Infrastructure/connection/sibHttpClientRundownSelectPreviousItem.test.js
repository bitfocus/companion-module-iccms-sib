...
describe('sibHttpClientRundownSelectPreviousItem', () => {
	...
	it('should construct the correct URL with token', async () => {
		...
		const result = await sibHttpClientRundownSelectPreviousItem(mockBaseUrl, mockToken, mockDeviceId)
	...
	it('should include deviceId as query parameter in the URL', async () => {
		...
		await sibHttpClientRundownSelectPreviousItem(mockBaseUrl, mockToken, mockDeviceId)
	...
	it('should reject on HTTP error status code', async () => {
		...
		await expect(sibHttpClientRundownSelectPreviousItem(mockBaseUrl, mockToken, mockDeviceId)).rejects.toThrow(
			'HTTP Error 500',
		)
	})
